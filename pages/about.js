...
const About = () => {
	...
	return (
		<div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
			<h2 className=" font-semibold lg:text-4xl text-3xl lg:leading-9 md:leading-7 leading-9 text-indigo-500">
			...
			<div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
				...
				<div className=" md:w-7/12 lg:w-8/12 w-full md:mt-0 sm:mt-14 mt-10">
					...
					<div>
						...
						>
							We are covering every major parish. The shipment leaves from us as
							it is our headquarter. Some extra information you probably need to
							add here so that the customer is clear of their wanted
							expectations.
						</p>
					</div>
					...
					<div>
						...
						>
							No refunds within three days of delivery.
						</p>
					</div>
					...
					<div>
						...
						>
							To stay updated just contact on day of delivery an we will keep
							you abreast.
						</p>
					</div>
